...
std::size_t BruteForceAttack::checkpoint_position() const {
    return current_index_;
}

void BruteForceAttack::resume_from_checkpoint(std::size_t absolute_index) {
    current_index_ = std::clamp(absolute_index, start_index_, end_index_);
}
