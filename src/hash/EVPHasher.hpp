...
identified by a tag struct (MD5Tag, SHA1Tag, SHA256Tag, SHA512Tag,
SHA3_256Tag, SHA3_512Tag) that provides the EVP_MD factory pointer,
display name, and expected hex length. EVPHasher<Tag> satisfies the
Hasher concept from Concepts.hpp.
...
Key exports:
  ...
  SHA3_256Hasher  - Type alias for EVPHasher<SHA3_256Tag>
  SHA3_512Hasher  - Type alias for EVPHasher<SHA3_512Tag>
...
struct SHA3_512Tag {
    static const EVP_MD *algorithm() { return EVP_sha3_512(); }
    static constexpr std::string_view name = "SHA3-512";
    static constexpr std::size_t hex_length = 128;
};
...
using SHA3_512Hasher = EVPHasher<evp::SHA3_512Tag>;
